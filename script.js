function fetchData()
{
    ...
    function init(resultFromServer) {
        ...
        windSpeedElement.innerHTML = 'Kecepatan Angin: ' + Math.floor(resultFromServer.wind.speed) + ' meter/s';
        cityHeader.innerHTML = resultFromServer.name;
        humidityElement.innerHTML = 'Tingkat Kelembapan: ' + resultFromServer.main.humidity +  '%';
